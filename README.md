...
```text
filetrail ~/Downloads                                                        5/6 traced
────────────────────────────────────────────────────────────────────────────────────
...
────────────────────────────────────────────────────────────────────────────────────
  1 browser download · 1 device metadata · 1 content credentials · 1 archive member
  5 of 6 files have a recorded origin.
```

Colour and box drawing are used when the output is a terminal, and dropped for
an identical plain-text layout when it is piped, when `NO_COLOR` is set, or with
...
```bash
pipx install git+https://github.com/OWNER/filetrail
```
