...
filegrail reconstructs **how a file reached a machine** and **what it reveals**, from evidence the system and its applications already left behind. Two different questions, and it never lets one answer the other.
...
The browser database says how the bytes arrived. The EXIF block describes the image years before that. Both stay, under the question each one answers, with a meter saying how directly the source knows what it claims.

It works **after the fact**: no agent, no provenance database, no browser extension, nothing installed before the file appeared.
...
Every block of output on this page is real — generated by running the tool, not written out by hand.
...
```text
  ...
  · notes.md                81 B  2026-09-05T19:46:02Z
  ...
  │ XDG attribute · 2026-09-05T19:46:02Z                    ▰▰▰▰▱ direct
