...
| Video / audio | MP4, M4V, MOV, 3GP, M4A, MP3, WAV, AVI | Encoder, device, creation time, ISO 6709 location, ID3 frames, RIFF `INFO` fields, BWF `bext` recorder and coding history |
