...
The palette has one rule: **colour encodes how the tool knows, never what it
found.** Every colour here names a class of evidence, so a reader learns five of
them once and can then triage a folder by eye.
"""
